package com.paperflywings.user.paperflyv0.PickupModule.PickupManager.FulfillmentAssignManager;
...
public class Fulfillment_Assign_pickup_Manager extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_testing_fulfillment);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_assign_f);
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
             /*   Snackbar.make(view, "Coming soon", Snackbar.LENGTH_LONG)
                ...
                Intent intentorder = new Intent(Fulfillment_Assign_pickup_Manager.this,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            assignFulfillmentExecutiveAdapter.setOnItemClickListener(Fulfillment_Assign_pickup_Manager.this);
    ...
    private void getallmerchant() {
        ...
        try {
            ...
            while (c.moveToNext()) {
                ...
                AssignFulfillmentManager_Model todaySummary = new AssignFulfillmentManager_Model(main_merchant,supplier_name,supplier_phone, supplier_address, product_name, product_id, sum, created_at, assign_status, merchant_code);
                assignFulfillmentManager_modelList.add(todaySummary);
            }
...
//            super.onBackPressed();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        try {
            ...
            e.printStackTrace();
            Intent intent_stay = new Intent(Fulfillment_Assign_pickup_Manager.this, AssignPickup_Manager.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent homeIntent = new Intent(Fulfillment_Assign_pickup_Manager.this,
                    ManagerCardMenu.class);
            startActivity(homeIntent);
        } else if (id == R.id.nav_pickDue) {
            Intent pickupIntent = new Intent(Fulfillment_Assign_pickup_Manager.this,
                    PickupsToday_Manager.class);
            startActivity(pickupIntent);
        } else if (id == R.id.nav_assign) {
            Intent assignIntent = new Intent(Fulfillment_Assign_pickup_Manager.this,
                    AssignPickup_Manager.class);
            startActivity(assignIntent);
        } else if (id == R.id.nav_fulfill) {
            Intent assignFulfillmentIntent = new Intent(Fulfillment_Assign_pickup_Manager.this,
                    Fulfillment_Assign_pickup_Manager.class);
            startActivity(assignFulfillmentIntent);
        }  else if (id == R.id.nav_robishop) {
            Intent robishopIntent = new Intent(Fulfillment_Assign_pickup_Manager.this,
                    Robishop_Assign_pickup_manager.class);
            startActivity(robishopIntent);
        }  else if (id == R.id.nav_adeal_direct) {
            Intent adealdirectIntent = new Intent(Fulfillment_Assign_pickup_Manager.this,
                    AjkerDealOther_Assign_Pickup_manager.class);
            startActivity(adealdirectIntent);
        /*} else if (id == R.id.nav_report) {
            Intent reportIntent = new Intent(Fulfillment_Assign_pickup_Manager.this,
            ...
            alertDialogBuilder.setPositiveButton("Yes",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            ...
                            Intent intent = new Intent(Fulfillment_Assign_pickup_Manager.this, LoginActivity.class);
...
//                params.put("order_count", order_count);
    ...
    public void onItemClick(View view, int position) {
        ...
        AlertDialog.Builder spinnerBuilder = new AlertDialog.Builder(Fulfillment_Assign_pickup_Manager.this);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(Fulfillment_Assign_pickup_Manager.this,
