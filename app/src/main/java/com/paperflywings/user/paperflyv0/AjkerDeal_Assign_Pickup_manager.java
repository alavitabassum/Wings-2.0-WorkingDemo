...
public class AjkerDeal_Assign_Pickup_manager extends AppCompatActivity
    ...
    private String MERCHANT_URL = "http://paperflybd.com/ajkerdeal_api.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajker_deal__assign__pickup_manager);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_assign_ajker_deal);
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
             /*   Snackbar.make(view, "Coming soon", Snackbar.LENGTH_LONG)
                ...
                Intent intentorder = new Intent(AjkerDeal_Assign_Pickup_manager.this,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ajkerDealAssignExecutiveAdapter.setOnItemClickListener(AjkerDeal_Assign_Pickup_manager.this);
...
/*
        ...
        try {
            ajkerdeal_modelList.clear();
            SQLiteDatabase sqLiteDatabase = database.getReadableDatabase();
            Cursor c = database.get_ajkerDeal_ekshop_merchantlist(sqLiteDatabase);
...
//        checkDataEntered( sum);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        try {
            ...
            e.printStackTrace();
            Intent intent_stay = new Intent(AjkerDeal_Assign_Pickup_manager.this, AssignPickup_Manager.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent homeIntent = new Intent(AjkerDeal_Assign_Pickup_manager.this,
                    ManagerCardMenu.class);
            startActivity(homeIntent);
        } else if (id == R.id.nav_pickDue) {
            Intent pickupIntent = new Intent(AjkerDeal_Assign_Pickup_manager.this,
                    PickupsToday_Manager.class);
            startActivity(pickupIntent);
        } else if (id == R.id.nav_assign) {
            Intent assignIntent = new Intent(AjkerDeal_Assign_Pickup_manager.this,
                    AssignPickup_Manager.class);
            startActivity(assignIntent);
        } else if (id == R.id.nav_fulfill) {
            Intent assignFulfillmentIntent = new Intent(AjkerDeal_Assign_Pickup_manager.this,
            ...
            alertDialogBuilder.setPositiveButton("Yes",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            ...
                            Intent intent = new Intent(AjkerDeal_Assign_Pickup_manager.this, LoginActivity.class);
    ...
    public void onItemClick(View view, int position) {
        ...
        AlertDialog.Builder spinnerBuilder = new AlertDialog.Builder(AjkerDeal_Assign_Pickup_manager.this);
...
//        String totalCount = String.valueOf(clickeditem.getSum());
        ...
        final String pick_merchant_name = "AjkerDeal.com";
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AjkerDeal_Assign_Pickup_manager.this,
...
//                    dialog.equals("Order count can't be empty");
                ...
                if (!mAutoComplete.getText().toString().isEmpty() || mAutoComplete.getText().toString().equals(null)) {
                    Toast.makeText(AjkerDeal_Assign_Pickup_manager.this, mAutoComplete.getText().toString()
