...
public class DeliveryDOReturnRcvByDO extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,DeliveryDOReturnRcvByDOAdapter.OnItemClickListtener, SwipeRefreshLayout.OnRefreshListener {

    BarcodeDbHelper db;
    private long mLastClickTime = 0;
    public SwipeRefreshLayout swipeRefreshLayout;
    private TextView btnselect, btndeselect, returnedorders;
    private DeliveryDOReturnRcvByDOAdapter deliveryDOReturnRcvByDOAdapter;
    ...
    private ArrayList<DeliveryDOReturnRcvByDOModel> list;
    private ArrayList<DeliveryDOReturnRcvByDOModel> courierList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delivery_doreturn_rcv_by_do);
        ...
        recyclerView_pul = findViewById(R.id.recycler_view_return_by_do);
        recyclerView_pul.setAdapter(deliveryDOReturnRcvByDOAdapter);
        list = new ArrayList<DeliveryDOReturnRcvByDOModel>();
        courierList = new ArrayList<DeliveryDOReturnRcvByDOModel>();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(i =0;i<array.length();i++)
                            {
                                ...
                                DeliveryDOReturnRcvByDOModel return_rcv_model = new  DeliveryDOReturnRcvByDOModel(
                            ...
                            deliveryDOReturnRcvByDOAdapter = new DeliveryDOReturnRcvByDOAdapter(list,getApplicationContext());
                            recyclerView_pul.setAdapter(deliveryDOReturnRcvByDOAdapter);
                            deliveryDOReturnRcvByDOAdapter.setOnItemClickListener(DeliveryDOReturnRcvByDO.this);
                            ...
                            btnnext.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    SharedPreferences sharedPreferences = getSharedPreferences(Config.SHARED_PREF_NAME, Context.MODE_PRIVATE);
                                    final String username = sharedPreferences.getString(Config.EMAIL_SHARED_PREF,"Not Available");
                                    final Intent intent = new Intent(DeliveryDOReturnRcvByDO.this, DeliveryDOReturnRcvByDO.class);
                                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(DeliveryDOReturnRcvByDO.this);
                                    ...
                                    ArrayAdapter<String> adapterCourierListR = new ArrayAdapter<String>(DeliveryDOReturnRcvByDO.this,
                                    ...
                                    for (int i = 0; i < DeliveryDOReturnRcvByDOAdapter.imageModelArrayList.size(); i++){
                                        if(DeliveryDOReturnRcvByDOAdapter.imageModelArrayList.get(i).getSelected()) {
                                            count++;
                                            item = item + "," + DeliveryDOReturnRcvByDOAdapter.imageModelArrayList.get(i).getOrderid();
                                        }
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            Intent homeIntent = new Intent(DeliveryDOReturnRcvByDO.this,
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        try{  searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                deliveryDOReturnRcvByDOAdapter.getFilter().filter(newText);
                return false;
            }
        });
        }
        ...
        {
            e.printStackTrace();
            Intent intent_stay = new Intent(DeliveryDOReturnRcvByDO.this, DeliveryDOReturnRcvByDO.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent expenseIntent = new Intent(DeliveryDOReturnRcvByDO.this,
...
//                            db.deleteAssignedList(sqLiteDatabase);
                            ...
                            Intent intent = new Intent(DeliveryDOReturnRcvByDO.this, LoginActivity.class);
    ...
    public void onRefresh() {
        ...
        deliveryDOReturnRcvByDOAdapter.notifyDataSetChanged();
        if(nInfo!= null && nInfo.isConnected())
        {
            loadRecyclerView(username, pointCode);
        }
    ...
    private ArrayList<DeliveryDOReturnRcvByDOModel> getModel(boolean isSelect){
        ArrayList<DeliveryDOReturnRcvByDOModel> listOfOrders = new ArrayList<>();
        if(isSelect == true){

            for(int i = 0; i < list.size(); i++){
                DeliveryDOReturnRcvByDOModel model = new DeliveryDOReturnRcvByDOModel();
    ...
    public void onItemClick_view(View view, int position) {
        ...
        DeliveryDOReturnRcvByDOModel clickedItem = list.get(position);
    ...
    private void getCourierDetails() {
        try {
            ...
            while (c.moveToNext()) {
                ...
                DeliveryDOReturnRcvByDOModel courierDetails = new DeliveryDOReturnRcvByDOModel(courierId,courierName);
    ...
    private void UpdateCourierResend(final String courierReturnBy,final String items,final String carrierId) {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, DELIVERY_RTS_SUP_API,
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(DeliveryDOReturnRcvByDO.this, "Server disconnected!", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
        ...
        try {
            ...
            Toast.makeText(DeliveryDOReturnRcvByDO.this, "Internet Connection Error!", Toast.LENGTH_LONG).show();
        }
    }
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                if(statusCode.equals("200")){
                                    loadRecyclerView(username, pointCode);
                                    Toast.makeText(DeliveryDOReturnRcvByDO.this, o.getString("success"), Toast.LENGTH_SHORT).show();

                                } else if(statusCode.equals("404")){
                                    Toast.makeText(DeliveryDOReturnRcvByDO.this, o.getString("unsuccess"), Toast.LENGTH_SHORT).show();
                                }
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
