...
public class DeliveryDOMultipleBatchSelectionModel {
    ...
    public DeliveryDOMultipleBatchSelectionModel(int id, String orderidList,String totalCashAmt, String createdBy, String createdAt, String serialNoCTRS) {
        this.id = id;
