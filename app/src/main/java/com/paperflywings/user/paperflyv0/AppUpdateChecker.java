    ...
    private class GetLatestVersion extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (latestVersion.equals("") || latestVersion.equals("Varies with device") || currentVersion.equals(latestVersion)) {
//                if (manualCheck) {
//                    Toast.makeText(activity, "No Update Available", Toast.LENGTH_SHORT).show();
//                } else {
                    //Toast.makeText(activity, "Your App is up-to-date", Toast.LENGTH_SHORT).show();
                    //  }
        ...
        protected String doInBackground(String... params) {
            try {
                //https://play.google.com/store/apps/details?id=com.paperflywings.user.paperflyv0
