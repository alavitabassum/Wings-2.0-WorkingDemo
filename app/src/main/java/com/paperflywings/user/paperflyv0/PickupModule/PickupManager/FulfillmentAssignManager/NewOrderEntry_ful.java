...
public class NewOrderEntry_ful extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_order_entry_ful);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(NewOrderEntry_ful.this,
       ...
       adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        ...
        ArrayAdapter<String> adapter3 = new ArrayAdapter<String>(NewOrderEntry_ful.this,
...
//                final String apiOrderID = "0";
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent(view.getContext(), Fulfillment_Assign_pickup_Manager.class);
        ...
        ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(NewOrderEntry_ful.this,
       ...
       actv_exe_name.setAdapter(adapter1);
        ...
        ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(NewOrderEntry_ful.this,
 ...
 private AdapterView.OnItemClickListener onItemClickListener =
    ...
    private void getallsupplier() {
        try {
            ...
            while (c.moveToNext()) {
                ...
                AssignFulfillmentManager_Model assignManager_supplierList = new AssignFulfillmentManager_Model(supplierName);
    ...
    private void getallproduct() {
        try {
            ...
            while (c.moveToNext()) {
                ...
                AssignFulfillmentManager_Model assignManager_productList = new AssignFulfillmentManager_Model(productName, productID);
    ...
    private void assignexecutive(final String ex_name, final String empcode, final String product_name, final String order_count, final String merchant_code, final String user, final String currentDateTimeString, final String m_name,final String contactNumber,final String p_m_name,final String p_m_address, final String complete_status,final String apiOrderID,final String demo, final String pick_from_merchant_status, final String received_from_HQ_status) {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, Fulfillment_Assign_pickup_Manager.INSERT_URL,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (!obj.getBoolean("error")) {
                                ...
                                database.assignexecutive(ex_name, empcode, product_name, order_count, merchant_code, user, currentDateTimeString,m_name,contactNumber,p_m_name,p_m_address, complete_status,apiOrderID, demo,pick_from_merchant_status, received_from_HQ_status,Fulfillment_Assign_pickup_Manager.NAME_SYNCED_WITH_SERVER);
...
//                                assignexecutivetosqlite(ex_name, empcode, product_name, order_count, merchant_code, user, currentDateTimeString, Fulfillment_Assign_pickup_Manager.NAME_SYNCED_WITH_SERVER,m_name,contactNumber,p_m_name,p_m_address, complete_status, apiOrderID,demo,pick_from_merchant_status, received_from_HQ_status);
                                ...
                                database.assignexecutive(ex_name, empcode, product_name, order_count, merchant_code, user, currentDateTimeString,m_name,contactNumber,p_m_name,p_m_address, complete_status,apiOrderID, demo,pick_from_merchant_status, received_from_HQ_status,Fulfillment_Assign_pickup_Manager.NAME_NOT_SYNCED_WITH_SERVER);
