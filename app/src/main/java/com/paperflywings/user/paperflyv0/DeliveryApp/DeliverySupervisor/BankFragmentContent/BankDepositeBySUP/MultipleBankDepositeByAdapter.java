...
public class MultipleBankDepositeByAdapter extends RecyclerView.Adapter<MultipleBankDepositeByAdapter.ViewHolder> implements Filterable {
    private ArrayList<MultipleBankDepositeBySUPModel> listFull;
    public ArrayList<MultipleBankDepositeBySUPModel> list;
    ...
    public void setOnItemClickListener(MultipleBankDepositeBySUP listener) {
    ...
    public MultipleBankDepositeByAdapter(java.util.ArrayList<MultipleBankDepositeBySUPModel> list, Context context) {
        this.list = list;
    ...
    private Filter NamesFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            List<MultipleBankDepositeBySUPModel>filteredList = new ArrayList<>();
            if (constraint == null || constraint.length() == 0){
                filteredList.addAll(listFull);
            }else {
                String filterPattern = constraint.toString().toLowerCase().trim();
                for(MultipleBankDepositeBySUPModel item: listFull){
