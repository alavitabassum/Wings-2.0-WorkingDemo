...
public class Bank_details_of_multiple_bank_by_DO extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapterBankListR1 = new ArrayAdapter<String>(Bank_details_of_multiple_bank_by_DO.this,
        ...
        ArrayAdapter<String> adapterBankListR2 = new ArrayAdapter<String>(Bank_details_of_multiple_bank_by_DO.this,
                android.R.layout.simple_spinner_item,
                bankLists2);
        ...
        ArrayAdapter<String> adapterBankListR3 = new ArrayAdapter<String>(Bank_details_of_multiple_bank_by_DO.this,
                android.R.layout.simple_spinner_item,
                bankLists3);
        ...
        ArrayAdapter<String> adapterBankListR4 = new ArrayAdapter<String>(Bank_details_of_multiple_bank_by_DO.this,
                android.R.layout.simple_spinner_item,
                bankLists4);
        ...
        ArrayAdapter<String> adapterBankListR5 = new ArrayAdapter<String>(Bank_details_of_multiple_bank_by_DO.this,
                android.R.layout.simple_spinner_item,
                bankLists5);
        ...
        selectDate1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog = new DatePickerDialog(Bank_details_of_multiple_bank_by_DO.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        UploadBn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //String
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Bank_details_of_multiple_bank_by_DO.this);
    ...
    public Bitmap getThumbnail(Uri uri) throws FileNotFoundException, IOException{
        ...
        input = Bank_details_of_multiple_bank_by_DO.this.getContentResolver().openInputStream(uri);
...
//                }
    ...
    public void onBackPressed() {
            ...
            super.onBackPressed();
            Intent intent = new Intent(Bank_details_of_multiple_bank_by_DO.this, DeliveryOfficerBankInfoAdd.class);
            startActivity(intent);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent homeIntent = new Intent(Bank_details_of_multiple_bank_by_DO.this,
...
*/
                            ...
                            Intent intent = new Intent(Bank_details_of_multiple_bank_by_DO.this, LoginActivity.class);
                            startActivity(intent);
                        }
                    });
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (!obj.getBoolean("error")) {
                                ...
                                Intent intent = new Intent(Bank_details_of_multiple_bank_by_DO.this, DeliveryOfficerBankInfoAdd.class);
                                Toast.makeText(Bank_details_of_multiple_bank_by_DO.this, "Successful", Toast.LENGTH_SHORT).show();
                                startActivity(intent);
                            } else {
                                Toast.makeText(Bank_details_of_multiple_bank_by_DO.this, "UnSuccessful", Toast.LENGTH_SHORT).show();
                            }
