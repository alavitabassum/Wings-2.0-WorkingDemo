...
public class DeliveryReturnManagementCourierSend extends AppCompatActivity {
    BarcodeDbHelper db;
    ...
    public static final String COURIER_DETAILS = "http://paperflybd.com/DeliverySupervisorAPI.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isLocationEnabled()) {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DeliveryReturnManagementCourierSend.this,
    ...
    private BarcodeCallback callback = new BarcodeCallback()  {
        ...
        public void barcodeResult(BarcodeResult result)  {
            ...
            db = new BarcodeDbHelper(DeliveryReturnManagementCourierSend.this);
           ...
           /* if(result.getText().equals(lastText)) {
            ...
            SendCourierBack(lastText, username);
            // onPause();
...
//            }
    ...
    private void SendCourierBack(final String barcode,final String courier_return_by){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, COURIER_DETAILS, new Response.Listener<String>() {
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        if(statusCode.equals("200")){
                            Toast.makeText(DeliveryReturnManagementCourierSend.this, o.getString("responseMsg"), Toast.LENGTH_SHORT).show();
                            onResume();
                            ...
                            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(DeliveryReturnManagementCourierSend.this);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("username", courier_return_by);
                params.put("flagreq", "Courier_send_back");
                return params;
            }
        };
   ...
   /* private void SearchCourierDetails(final String barcode){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, COURIER_DETAILS, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
