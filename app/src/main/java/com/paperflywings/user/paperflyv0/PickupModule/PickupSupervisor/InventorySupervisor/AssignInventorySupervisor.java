package com.paperflywings.user.paperflyv0.PickupModule.PickupSupervisor.InventorySupervisor;
...
public class AssignInventorySupervisor extends AppCompatActivity {

    String[] executive_num_list;
    public static final String MERCHANT_NAME = "Merchant Name";

    private String INSERT_URL = "http://paperflybd.com/insertassign.php";
   ...
   /* public static final String DATA_SAVED_BROADCAST = "net.simplifiedcoding.datasaved";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_order_inventory);
...
//            Toast.makeText(this,"Check Your Internet Connection",Toast.LENGTH_LONG).show();
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AssignInventorySupervisor.this,
        ...
        actv_m_name.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(final AdapterView<?> adapterView, View view, final int i, long l) {
                ...
                final String complete_sttaus = "I";
                ...
                final String merchantcode = database.getSelectedMerchantCodeIn(adapterView.getItemAtPosition(i).toString());
                final String merchantaddress = database.getSelectedMerchantAddressIn(adapterView.getItemAtPosition(i).toString());

                button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        assignexecutive(actv_exe_name.getText().toString(),empcode, product_name, count.getText().toString(), merchantcode, user, currentDateTimeString,merchantname,contactNumber,merchantname,  merchantaddress, complete_sttaus,apiOrderID,demo, pick_from_merchant_status, received_from_HQ_status);
                        ...
                        Intent intent = new Intent(view.getContext(), AssignInventorySupervisor.class);
        ...
        ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(AssignInventorySupervisor.this,
    ...
    private void getallmerchantlist() {
        try {
            ...
            Cursor c = database.get_All_Inventory_merchantlist(sqLiteDatabase);
            while (c.moveToNext()) {
                ...
                AssignManager_Model todaySummary = new AssignManager_Model(merchantName, merchantCode,address, contactName, contactNumber);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (!obj.getBoolean("error")) {
                                ...
                                database.assignexecutive(ex_name, empcode, product_name, order_count, merchant_code, user, currentDateTimeString,m_name,contactNumber,p_m_name,p_m_address, complete_status,apiOrderID,demo, pick_from_merchant_status, received_from_HQ_status, NAME_SYNCED_WITH_SERVER);
...
//                                database.assignexecutive(ex_name, empcode, product_name, order_count, merchant_code, user, currentDateTimeString, AssignPickup_Manager.NAME_SYNCED_WITH_SERVER,m_name,contactNumber,p_m_name,p_m_address, complete_status,apiOrderID,demo, pick_from_merchant_status, received_from_HQ_status);
                                ...
                                database.assignexecutive(ex_name, empcode, product_name, order_count, merchant_code, user, currentDateTimeString,m_name,contactNumber,p_m_name,p_m_address, complete_status,apiOrderID,demo, pick_from_merchant_status, received_from_HQ_status, NAME_NOT_SYNCED_WITH_SERVER);
...
//
        super.onBackPressed();
        Intent homeIntentSuper = new Intent(AssignInventorySupervisor.this,
