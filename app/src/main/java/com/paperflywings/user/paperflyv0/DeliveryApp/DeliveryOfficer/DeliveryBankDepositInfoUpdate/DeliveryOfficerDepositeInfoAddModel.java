...
public class DeliveryOfficerDepositeInfoAddModel {
    ...
    public DeliveryOfficerDepositeInfoAddModel(int id, String orderidList,String totalCashAmt, String createdBy, String createdAt, String serialNoCTRS) {
    this.id = id;
