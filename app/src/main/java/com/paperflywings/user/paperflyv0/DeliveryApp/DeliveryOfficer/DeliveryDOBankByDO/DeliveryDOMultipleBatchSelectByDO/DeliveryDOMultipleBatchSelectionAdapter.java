...
public class DeliveryDOMultipleBatchSelectionAdapter extends RecyclerView.Adapter<DeliveryDOMultipleBatchSelectionAdapter.ViewHolder> implements Filterable {
    private ArrayList<DeliveryDOMultipleBatchSelectionModel> listFull;
    public ArrayList<DeliveryDOMultipleBatchSelectionModel> list;
    ...
    public void setOnItemClickListener(DeliveryDOMultipleBatchSelection listener) {
    ...
    public DeliveryDOMultipleBatchSelectionAdapter(java.util.ArrayList<DeliveryDOMultipleBatchSelectionModel> list, Context context) {
        this.list = list;
    ...
    private Filter NamesFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            List<DeliveryDOMultipleBatchSelectionModel>filteredList = new ArrayList<>();
            if (constraint == null || constraint.length() == 0){
                filteredList.addAll(listFull);
            }else {
                String filterPattern = constraint.toString().toLowerCase().trim();
                for(DeliveryDOMultipleBatchSelectionModel item: listFull){
