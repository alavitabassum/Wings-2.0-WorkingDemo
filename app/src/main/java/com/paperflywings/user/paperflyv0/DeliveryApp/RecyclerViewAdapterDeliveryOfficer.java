...
/*public class RecyclerViewAdapterDeliveryOfficer {
...
public class RecyclerViewAdapterDeliveryOfficer extends RecyclerView.Adapter<com.paperflywings.user.paperflyv0.DeliveryApp.RecyclerViewAdapterDeliveryOfficer.ViewHolder> {
    ...
    @Override
    public com.paperflywings.user.paperflyv0.DeliveryApp.RecyclerViewAdapterDeliveryOfficer.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.exe_card_layout, viewGroup, false);
        com.paperflywings.user.paperflyv0.DeliveryApp.RecyclerViewAdapterDeliveryOfficer.ViewHolder viewHolder = new com.paperflywings.user.paperflyv0.DeliveryApp.RecyclerViewAdapterDeliveryOfficer.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(com.paperflywings.user.paperflyv0.DeliveryApp.RecyclerViewAdapterDeliveryOfficer.ViewHolder viewHolder, int i) {
