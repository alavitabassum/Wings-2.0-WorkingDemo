package com.paperflywings.user.paperflyv0.PickupManager.AjkerdealdirectdeliveryManager;
...
//            super.onBackPressed();
            Intent homeIntentSuper = new Intent(AjkerDealOther_Assign_Pickup_manager.this,
...
//                    getEmpInfo(order_id,empcode);
    ...
    public void onItemClick_view(View view2, int position2) {
        ...
        Intent intent = new Intent(AjkerDealOther_Assign_Pickup_manager.this, AjkerDealOther_Assign_Pickup_manager.class);
    ...
    public void onItemClick_update(View view3, int position3) {
        ...
        final String user = username.toString();
        final String currentDateTimeString = DateFormat.getDateTimeInstance().format(new Date());
        String merchantname = clickeditem3.getMerchantCode();
