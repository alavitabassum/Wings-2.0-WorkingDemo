...
public class DeliveryDOCashRcvByDOAdapter extends RecyclerView.Adapter<DeliveryDOCashRcvByDOAdapter.ViewHolder>implements Filterable {
    private List<DeliveryDOCashRcvByDOModel> listfull;
    private List<DeliveryDOCashRcvByDOModel> list;
    ...
    public DeliveryDOCashRcvByDOAdapter(List<DeliveryDOCashRcvByDOModel>list, Context context){
        this.list = list;
...
*/
    ...
    private Filter NamesFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            List<DeliveryDOCashRcvByDOModel>filteredList = new ArrayList<>();
            if (constraint == null || constraint.length() == 0){
                filteredList.addAll(listfull);
            }else {
                String filterPattern = constraint.toString().toLowerCase().trim();
                for(DeliveryDOCashRcvByDOModel item: listfull){
