package com.paperflywings.user.paperflyv0.DeliveryApp.DeliveryOfficer.DeliveyrOfficerWithoutStatus;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, DELIVERY_STATUS_UPDATE,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (!obj.getBoolean("error")) {
                                ...
                                startActivity(withoutstatuscount);*/
                                Toast.makeText(DeliveryWithoutStatus.this, "Error Loading Data. Please Try again later!", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                       /* db.update_cash_status(cash,cashType,cashTime,cashBy,cashAmt,cashComment,orderid,flagReq,NAME_NOT_SYNCED_WITH_SERVER);
                        startActivity(withoutstatuscount);*/
                        Toast.makeText(DeliveryWithoutStatus.this, "Unsuccessful! No Internert connection.", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
