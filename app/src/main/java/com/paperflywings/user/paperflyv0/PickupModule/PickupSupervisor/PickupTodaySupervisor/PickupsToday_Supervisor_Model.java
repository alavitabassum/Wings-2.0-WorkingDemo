...
public class PickupsToday_Supervisor_Model {
    ...
    public PickupsToday_Supervisor_Model(String name, String code, String count, String executive_name, String created_at, String complete_status, String picked_qty, String p_m_name, String product_name) {
    ...
    public PickupsToday_Supervisor_Model(String sql_primary_id,String merchant_name, String assined_qty, String scan_count,String executive_name,String created_at, String complete_status,String picked_qty, String p_m_name, String product_name, String demo) {
        this.sql_primary_id = sql_primary_id;
        this.merchant_name = merchant_name;
        this.assined_qty = assined_qty;
        this.scan_count = scan_count;
    ...
    public PickupsToday_Supervisor_Model() {
