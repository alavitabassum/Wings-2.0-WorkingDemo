...
public class AssignPickup_Supervisor extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,  AssignSupervisorAdapter.OnItemClickListener,SwipeRefreshLayout.OnRefreshListener {
...
//    public static final String INSERT_URL = "http://paperflybd.com/insertfulfillmentassign.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assign_pickup__supervisor);
        database = new Database(getApplicationContext());
        database.getWritableDatabase();
        executiveLists = new ArrayList<>();
        assignSupervisor_modelList = new ArrayList<>();
        CardView cardview = findViewById(R.id.card_view_assign_supervisor);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view_sup_merlist);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                JSONObject o = array.getJSONObject(i);
                                AssignSupervisor_Model todaySummary = new AssignSupervisor_Model(
                            ...
                            assignSupervisorAdapter = new AssignSupervisorAdapter(assignSupervisor_modelList, getApplicationContext());
                            recyclerView.setAdapter(assignSupervisorAdapter);
                            swipeRefreshLayout.setRefreshing(false);
                            assignSupervisorAdapter.setOnItemClickListener(AssignPickup_Supervisor.this);
    ...
    private void getallmerchant() {
        ...
        try {
            ...
            while (c.moveToNext()) {
                ...
                AssignSupervisor_Model todaySummary = new AssignSupervisor_Model(merchantName, merchantCode,totalcount,contactNumber,p_m_name,p_m_address,p_assigned_status,address);
                assignSupervisor_modelList.add(todaySummary);
            }
...
//            super.onBackPressed();
        ...
        try {
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String newText) {
                    assignSupervisorAdapter.getFilter().filter(newText);
                    return false;
                }
            });
        } catch (Exception e) {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent homeIntent = new Intent(AssignPickup_Supervisor.this,
                    SupervisorCardMenu.class);
            ...
            alertDialogBuilder.setPositiveButton("Yes",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            ...
                            Intent intent = new Intent(AssignPickup_Supervisor.this, LoginActivity.class);
    ...
    public void onItemClick(View view, int position) {
        ...
        final AssignSupervisor_Model clickeditem = assignSupervisor_modelList.get(position);

        AlertDialog.Builder spinnerBuilder = new AlertDialog.Builder(AssignPickup_Supervisor.this);
...
//        final String p_m_name_test = clickeditem.getPick_m_name()
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(AssignPickup_Supervisor.this,
...
//                    updatePickAssigedStatus(merchant_code, pickAssidnedStatus,et1.getText().toString());
    ...
    public void onItemClick_view(View view2, int position2) {
        ...
        final AssignSupervisor_Model clickeditem2 = assignSupervisor_modelList.get(position2);
        SharedPreferences sharedPreferences = getSharedPreferences(Config.SHARED_PREF_NAME, Context.MODE_PRIVATE);
        String username = sharedPreferences.getString(Config.EMAIL_SHARED_PREF, "Not Available");
        final String user = username.toString();
        final String currentDateTimeString = DateFormat.getDateTimeInstance().format(new Date());
        ...
        Intent intent = new Intent(AssignPickup_Supervisor.this, ViewAssigns.class);
    ...
    public void onItemClick_update(View view3, int position3) {
        final AssignSupervisor_Model clickeditem3 = assignSupervisor_modelList.get(position3);
        SharedPreferences sharedPreferences = getSharedPreferences(Config.SHARED_PREF_NAME, Context.MODE_PRIVATE);
        String username = sharedPreferences.getString(Config.EMAIL_SHARED_PREF, "Not Available");
        final String user = username.toString();
        final String currentDateTimeString = DateFormat.getDateTimeInstance().format(new Date());
        ...
        String product_name = "0";
        Intent intent = new Intent(AssignPickup_Supervisor.this, UpdateAssigns.class);
        intent.putExtra("MERCHANTNAME", merchantname);
        intent.putExtra("MERCHANTCODE", merchantcode);
        intent.putExtra("SUBMERCHANT", p_m_name);
        intent.putExtra("PRODUCTNAME", product_name);
    ...
    public void onRefresh() {
        ...
        String username = sharedPreferences.getString(Config.EMAIL_SHARED_PREF,"Not Available");
        assignSupervisor_modelList.clear();
        assignSupervisorAdapter.notifyDataSetChanged();
        //If internet connection is available or not
        if(nInfo!= null && nInfo.isConnected())
        {
