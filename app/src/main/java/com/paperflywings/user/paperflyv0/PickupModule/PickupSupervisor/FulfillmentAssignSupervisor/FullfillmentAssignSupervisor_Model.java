...
public class FullfillmentAssignSupervisor_Model  {
    ...
    public FullfillmentAssignSupervisor_Model(String main_merchant, String supplier_name, String supplier_phone, String supplier_address, String product_name, String product_id, int sum, String created_at, String assign_status, String merchant_code) {
...
//        this.status = status;
    ...
    public FullfillmentAssignSupervisor_Model(String main_merchant, String supplier_name, String supplier_phone, String supplier_address, String product_name, String product_id, int sum, String created_at, String assign_status, String merchant_code, int status) {
