...
public class DeliveryOnHold extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,DeliveryOnHoldAdapter.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
...
//        GetValueFromEditText();
    ...
    private void getData(String user){
        try{
            ...
            String str = String.valueOf(db.getWithoutStatusCount("OnHold"));
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (!obj.getBoolean("error")) {
                                ...
                                startActivity(withoutstatuscount);*/
                                Toast.makeText(DeliveryOnHold.this, "Error Loading Data. Please Try again later!", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
