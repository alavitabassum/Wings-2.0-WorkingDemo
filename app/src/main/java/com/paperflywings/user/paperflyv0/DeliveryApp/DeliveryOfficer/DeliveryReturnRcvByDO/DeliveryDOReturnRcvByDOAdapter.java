...
public class DeliveryDOReturnRcvByDOAdapter extends RecyclerView.Adapter<DeliveryDOReturnRcvByDOAdapter.ViewHolder> implements Filterable {
    private ArrayList<DeliveryDOReturnRcvByDOModel> listFull;
    public ArrayList<DeliveryDOReturnRcvByDOModel> list;
    public static ArrayList<DeliveryDOReturnRcvByDOModel> imageModelArrayList;
    ...
    public void setOnItemClickListener(DeliveryDOReturnRcvByDO listener) {
    ...
    public DeliveryDOReturnRcvByDOAdapter(java.util.ArrayList<DeliveryDOReturnRcvByDOModel> list, Context context) {
        this.list = list;
    ...
    private Filter NamesFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            List<DeliveryDOReturnRcvByDOModel>filteredList = new ArrayList<>();
            if (constraint == null || constraint.length() == 0){
                filteredList.addAll(listFull);
            }else {
                String filterPattern = constraint.toString().toLowerCase().trim();
                for(DeliveryDOReturnRcvByDOModel item: listFull){
