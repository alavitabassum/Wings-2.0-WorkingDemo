...
public class DeliverySupCRSModel {
    ...
    public DeliverySupCRSModel(int id,String orderidList,String totalCashAmt, String submittedCashAmt,String totalCashReceive,String comment, String comment_by_supervisor, String createdBy,String createdAt, String serialNo, String totalOrders) {
        this.id = id;
        this.orderidList = orderidList;
        this.totalCashAmt = totalCashAmt;
        this.submittedCashAmt = submittedCashAmt;
