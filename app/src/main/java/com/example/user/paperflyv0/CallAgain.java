...
public class CallAgain extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_call_again);
        ...
        btn_editSchedule.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(CallAgain.this,
                        CallAgain.this,year,month,day);
    ...
    public void onDateSet(DatePicker datePicker, int i, int i1, int i2) {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(CallAgain.this,
                CallAgain.this,hour,minute, DateFormat.is24HourFormat(this));
    ...
    public void onTimeSet(TimePicker timePicker, int i, int i1) {
        ...
        rescheduleOutput.setText("Call Again Date: "+yearUpdated+":"+monthUpdated+":"+dayUpdated + "\n" +
                "Call Again Time: " + hourUpdated + ":" + minuteUpdated );
    }
